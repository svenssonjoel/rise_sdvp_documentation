...
\end{minipage}
\begin{minipage}{0.5\textwidth} %% Text Car orientation
...
\noindent {\bf AutoPilot:} Configure the behavior of the auto
...
\noindent\begin{minipage}{0.5\linewidth}
\noindent\includegraphics[width=\textwidth]{./screens/base_station_new.png}
\end{minipage}
\noindent\begin{minipage}{0.5\linewidth}
  The position of the base station can be hard-coded in the {\em Base
    Station Position} or derived using the {\em survey in} functionality.
  When using the survey in functionality you can also set constraints on the
  desired accuracy.
  ...
  internal SDVP message transmission system or via a TCP server.
\end{minipage}
...
\begin{changeentry}{2018-09-13}{Joel}
Initial version focusing on the RControlStation GUI in relation to the
RC-car.
\end{changeentry}
